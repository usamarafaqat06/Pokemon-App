        ...
        <div className="relative container mx-auto py-[50px] flex items-center justify-center">
          ...
          <div className={`${page === 1 ? "hidden" : "block"}`}>
            <button
              ...
              className="w-12 h-12 bg-white flex items-center font-bold justify-center shadow-lg rounded-full absolute xl:left-[-30px] left-[10px]   top-[50vh] transition duration-500 hover:bg-[gray] "
            >
          ...
          >
            {pokemonData && (
              <button
                onClick={() => setPage(page + 1)}
                className="w-12 h-12 bg-white flex items-center justify-center font-bold shadow-lg rounded-full absolute right-[10px] xl:right-[-30px]  top-[50vh] transition duration-500 hover:bg-[gray]"
              >
